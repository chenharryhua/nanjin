...
//
//  val tigerEncoder: RowEncoder[Tiger] = RowEncoder.encoder[Tiger,Int,Option[String]]((t:Tiger) => (t.id,t.zooName))
//  val tigerDecoder: RowDecoder[Tiger] = RowDecoder.decoder[Int,Option[String],Tiger](Tiger.apply)
...
//    fs2(fs2Root, KantanFile(_.Deflate(Level(6))), cfg, tigerSet)
//  }
//
//  test("laziness") {
