...
import com.github.chenharryhua.nanjin.guard.config.{ServiceIdentity, ServiceParams}
...
object gendata {
  ...
  implicit val exhaustiveCheck: ExhaustiveCheck[Event] =
    ExhaustiveCheck.instance(List(ServiceStart(null.asInstanceOf[ServiceIdentity], null.asInstanceOf[ServiceParams], tick)))
