...
object PrettyJsonTranslator {
  ...
  private def service_message(evt: ServiceMessage): Json =
    Json.obj(EventName.ServiceMessage.snake -> jsonHelper.json_service_message(evt))
