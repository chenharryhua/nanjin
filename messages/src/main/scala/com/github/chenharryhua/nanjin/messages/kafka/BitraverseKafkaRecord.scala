...
private[kafka] trait BitraverseKafkaRecord {
  ...
  implicit final val bitraverseConsumerRecord: Bitraverse[ConsumerRecord] =
    new Bitraverse[ConsumerRecord] {
      ...
      override def bimap[K1, V1, K2, V2](cr: ConsumerRecord[K1, V1])(k: K1 => K2, v: V1 => V2): ConsumerRecord[K2, V2] =
      ...
      override def bitraverse[G[_], A, B, C, D](fab: ConsumerRecord[A, B])(f: A => G[C], g: B => G[D])(implicit
  ...
  implicit final val bitraverseProducerRecord: Bitraverse[ProducerRecord] =
    new Bitraverse[ProducerRecord] {
      ...
      override def bimap[K1, V1, K2, V2](pr: ProducerRecord[K1, V1])(k: K1 => K2, v: V1 => V2): ProducerRecord[K2, V2] =
        new ProducerRecord[K2, V2](pr.topic, pr.partition, pr.timestamp, k(pr.key), v(pr.value), pr.headers)

      override def bitraverse[G[_], A, B, C, D](fab: ProducerRecord[A, B])(f: A => G[C], g: B => G[D])(implicit
