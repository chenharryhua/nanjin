...
object zones {
  ...
  // Beijing Time (China Standard Time) is the conventional name; IANA anchors the zone at Asia/Shanghai
  final val beijingTime: ZoneId = ZoneId.of("Asia/Shanghai")
  final val singaporeTime: ZoneId = ZoneId.of("Asia/Singapore")
  // India Standard Time; IANA anchors the zone at Asia/Kolkata
