...
class SortTest extends AnyFunSuite {
  ...
  val data = List(
    OptionalKV[Int, Int](0, 0, 20, Some(0), Some(Random.nextInt()), "topic", 0),
    OptionalKV[Int, Int](0, 1, 30, Some(1), Some(Random.nextInt()), "topic", 0),
    OptionalKV[Int, Int](0, 2, 40, Some(2), Some(Random.nextInt()), "topic", 0),
    OptionalKV[Int, Int](0, 3, 10, Some(3), Some(Random.nextInt()), "topic", 0),
    OptionalKV[Int, Int](1, 0, 20, Some(4), Some(Random.nextInt()), "topic", 0),
    OptionalKV[Int, Int](1, 1, 40, Some(5), Some(Random.nextInt()), "topic", 0),
    OptionalKV[Int, Int](1, 2, 40, Some(6), Some(Random.nextInt()), "topic", 0),
