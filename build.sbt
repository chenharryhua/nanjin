...
lazy val pipes = (project in file("pipes"))
  ...
  .settings(libraryDependencies ++= base ++ fs2 ++ hadoopLib ++ effect ++ json ++ kantan ++ avro ++ tests)
...
lazy val nanjin =
  (project in file("."))
    ...
    .aggregate(common, datetime, pipes, kafka, flink, database, hadoop, spark, graph)
